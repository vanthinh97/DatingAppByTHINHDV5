...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            var otherUser = httpContext.Request.Query["user"].ToString(); // lay ten ng dung khac
            ...
            //Khi send cai ReceiveMessageThread thi ben message.service se nhan gia tri
            //sau do day len observable
        }
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            //day la http response nen k dung badrequest
